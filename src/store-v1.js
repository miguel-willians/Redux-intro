...
// createStore é uma função obsoleta que foi substituída no RTK
...
// Root reducer: O reducer que combinará todos os outros
...
store.dispatch(createCustomer("Miguel Willians", 1144845));
console.log(store.getState());
